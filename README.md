...
3. **Choose your platform:**
   ...
   - **Linux:** Open the `linux-x64/` folder and use the command `./run.sh` to launch the game.
     - ***Note:*** *If the game fails to launch, ensure the file has execute permissions `chmod +x Dwindling_Galaxies run.sh`.*
